...
export default function TasksPage() {
  ...
  return (
    <main className="h-screen snap-y snap-mandatory">
      <section className="h-screen snap-start flex items-start">
        <div className="scale-[0.85] origin-top w-full container mx-auto px-4 mt-2">
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <h2 className="text-4xl font-extralight">Tasks - {format(new Date(), "EEEE, MMMM do")}</h2>
